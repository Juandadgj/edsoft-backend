...
export function lostGlobalNotesSheetByCourseExcelTemplate(
  data: any[],
  ...
  <head>
    ...
    <title>Sabana de notas perdidas globales por curso (Excel)</title>
              ...
              <tbody>
                <tr height="80" border="0">
                  <td align="center" width="">
                    ...
                    <center>
                      Sabana de notas perdidas globales por curso (Excel)
                    </center>
                  </td>
                </tr>
              </tbody>
              ...
              <tbody>
                ...
                ${data
                  ...
                  <tr>
                    ...
                    <td><center>${item.period}</center></td>
                  </tr>
                `,
                  )
                  .join('')}
