...
export function minimumNotesCalculationByPeriodExcelTemplate(
  data: any[],
  ...
  <head>
    ...
    <title>Calculo de notas minimas por periodo</title>
              ...
              <tbody>
                <tr height="80" border="0">
                  <td align="center" width="">
                    ...
                    <center>
                      Calculo de notas minimas por periodo
                    </center>
                  </td>
                </tr>
              </tbody>
            ...
            <table width="100%" border="1" cellpadding="3" cellspacing="0">
              <tbody>
                <tr>
                  ...
                  <td><center><b>Mínimo</b></center></td>
                </tr>
                ${data
                  .map(
                    (item) => `
                  <tr>
                    ...
                    <td><center>${item.minimum}</center></td>
                  </tr>
                `,
                  )
                  .join('')}
