...
export function allGlobalNotesSheetByCourseExcelTemplate(
  data: any[],
  ...
  <head>
    ...
    <title>Sabana de todas las notas globales por curso (Excel)</title>
              ...
              <tbody>
                <tr height="80" border="0">
                  <td align="center" width="">
                    ...
                    <center>
                      Sabana de todas las notas globales por curso (Excel)
                    </center>
                  </td>
                </tr>
              </tbody>
              ...
              <tbody>
                ...
                ${data
                  ...
                  <tr>
                    ...
                    <td><center>${item.final}</center></td>
                  </tr>
                `,
                  )
                  .join('')}
